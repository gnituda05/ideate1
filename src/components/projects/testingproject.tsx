			...
			<div className="flex flex-col mx-auto max-w-screen-xl gap-5  overflow-hidden">
				<div className="relative h-screen max-h-700:mb-96 min-h-700:mb-48 xl:mb-52 lg:mt-10 xl:mt-1 ">
					...
					>
						{" "}
						<div className="">
							<div className="flex flex-col mt-24 xl:mt-36 w-full px-2 font-general-sans transition duration-1000 ease-in-out group-hover:blur-md ">
								...
								<div className="xl:flex flex-row gap-4 xl:gap-8">
									...
									<div className="flex space-x-4 lg:space-x-8 lg:mb-8">
										...
										<div className="w-40 h-60 lg:w-64 lg:h-72 rounded-lg flex flex-col bg-blue-600 text-white">
											...
											>
												<h2 className=" text-5xl lg:text-6xl font-bold font-general-sans text-right me-3 mt-2 text-lime-400  ">
													*
												</h2>
												<img
													src={brand}
												...
												/>
												<p className="text-base lg:text-lg font-general-sans mt-2 custom-heading1  leading-none font-bold text-left ms-3 lg:ms-4  ease-in-out duration-500 transform group-hover:translate-y-[-300%] lg:group-hover:translate-y-[-350%] ">
													BRAND IDENTITY <br></br> DESIGN
												</p>
												<div
													className={` absolute p-5 mt-20 lg:mt-24 border-none inset-0  duration-500 group-hover:opacity-100 opacity-0 transition-opacity ${
														hover ? "translate-x-0" : "-translate-x-full"
													}`}
												>
													<p className="text-xs lg:text-base custom-paragraphMb lg:custom-paragraph font-lato text-left leading-none">
														Through a thoughtful combination of elements, we
														create a cohesive and impactful brand presence that
														leaves a lasting impression on our client's
														business.
													</p>
												</div>
											</div>
										...
										<div className="w-40 h-60 lg:w-64 lg:h-72 rounded-lg flex flex-col bg-white  text-black">
											<div
												...
												onMouseLeave={() => setHover(false)}
											>
												<h2 className=" text-5xl lg:text-6xl font-bold font-general-sans text-right me-3 mt-2 text-blue-400 duration-500 ease-in-out ">
													*
												</h2>
												<img
													src={web}
												...
												/>
												<p className="text-base lg:text-lg font-general-sans custom-heading1  leading-none font-bold text-left ms-4 mt-1 ease-in-out duration-500 transform group-hover:translate-y-[-300%] lg:group-hover:translate-y-[-350%]">
									...
									<div className="flex space-x-4 lg:space-x-8 mt-10 lg:mt-0">
										...
										<div className="w-40 h-60 lg:w-64 lg:h-72 rounded-lg flex flex-col bg-blue-600 text-white">
											<div
												...
												onMouseLeave={() => setHover(false)}
											>
												<h2 className=" text-5xl lg:text-6xl font-bold font-general-sans text-right me-3 mt-2 text-lime-400 duration-500 ease-in-out ">
													*
												</h2>
												<img
													src={soft}
													...
													className="h-12 w-12 lg:h-16 lg:w-16 ms-3 mt-12 lg:mt-16 group-hover:opacity-0 opacity-100 transition-opacity   "
												/>
												<p className="text-base lg:text-lg font-general-sans custom-heading1 leading-none font-bold text-left ms-4 mt-2 ease-in-out duration-500 transform group-hover:translate-y-[-300%] lg:group-hover:translate-y-[-350%]">
											...
											>
												...
												>
													<p className="text-xs lg:text-base font-lato custom-paragraphMb lg:custom-paragraph text-left leading-none">
														...
														qualified talents who seamlessly integrate into
														their workflows and contribute to the sucess of
														their project.
													</p>
												</div>
											</div>
