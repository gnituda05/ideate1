			...
			<div className="flex flex-col mx-auto max-w-screen-xl gap-6 mb-32 lg:mt-20 ">
				...
				<div className="flex flex-col mt-0 ">
					...
					<div className="flex flex-col gap-1 p-8 ">
						<p className="text-sm lg:text-xl font-lato text-left text-white">
							...
							<br></br>
							Join us in our design-driven innovation journey.
						</p>
					</div>
				</div>
					...
					>
						...
						>
							<div className="text-center text-white">
								...
								<h2 className="text-5xl mt-20 font-bold font-general-sans text-white">
									MARA C
								</h2>
					...
					>
						...
						>
							<div className="text-center text-white">
								...
								<h2 className="text-5xl mt-14 font-bold font-general-sans  text-white">
									WE <br></br>RENEGADES
								</h2>
								<p className="text-xs font-medium font-lato  text-white">
									GENTS OF TODAY
